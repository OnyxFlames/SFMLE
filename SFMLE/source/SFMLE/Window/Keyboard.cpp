...
//namespace sfe
//{
//	const std::string Keyboard::ToString(sf::Keyboard::Key key)
//	{
//		switch (key)
//		{
...
//		}
//	}
//	const sf::Keyboard::Key Keyboard::FromString(const std::string& key)
//	{
//		if (!priv::keyNameMap.contains(key)) sf::Keyboard::Unknown;
//
//		return priv::keyNameMap.at(key);
//	}
//	const std::string Keyboard::Scancode::ToString(sf::Keyboard::Scancode scancode)
//	{
//		assert(false && "Implement sfe::Keyboard::Scancode::ToString()");
//		return std::string();
//	}
//	const sf::Keyboard::Scancode Keyboard::Scancode::FromString(const std::string& scancode)
//	{
